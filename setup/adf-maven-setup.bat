...
call mvn install:install-file -Dfile=%MIDDLEWARE_HOME%/oracle_common/modules/oracle.adf.view_11.1.1/trinidad-api.jar -DgroupId=org.apache.myfaces.trinidad -DartifactId=trinidad-api -Dversion=1.2.12.3-SNAPSHOT -Dpackaging=jar -DgeneratePom=true
call mvn install:install-file -Dfile=%MIDDLEWARE_HOME%/oracle_common/modules/oracle.adf.view_11.1.1/trinidad-impl.jar -DgroupId=org.apache.myfaces.trinidad -DartifactId=trinidad-impl -Dversion=1.2.12.3-SNAPSHOT -Dpackaging=jar -DgeneratePom=true		
